...
public:
	...
	const unsigned int COLUMNS[8] = { 1, 2, 4, 8, 16, 32, 64, 128 };	//A-H
																		...
																		//Convert to AISpace
	const unsigned long AISQUARES[][8] = { { 1, 2, 4, 8, 16, 32, 64, 128 },
	...
	Board();
	Board(int newBlackCount, int newWhiteCount, unsigned long newBlack, unsigned long newWhite);
	void fromBoard(Board& oldBoard);
	void setParameters(int newBlackCount, int newWhiteCount, unsigned long newBlack, unsigned long newWhite);
